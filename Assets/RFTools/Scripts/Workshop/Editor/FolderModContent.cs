...
public class FolderModContent {
	...
	public static readonly string[] CONTENT_EXTENSIONS = {".rfl", ".rfc", ".rgc", ".patch"};
	...
	public void MarkAsFileReplaced(FileInfo file, FileInfo newFile) {
	...
	public void MarkAsUpdated(FileInfo file) {
	...
	public bool HasLocalVersionOfFile(FileInfo file, out FileInfo localVersion) {
